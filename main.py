...
system_instruction = (
    ...
    "3. Предложения по корректировке.\n\n"
    "ВАЖНОЕ ТРЕБОВАНИЕ К ТАБЛИЦЕ ДЛЯ TELEGRAM:\n"
    "Обычные markdown-таблицы в Telegram съезжают и выглядят кашей. "
    "Поэтому, если требуется корректировка базала, ты обязан вывести сравнительную таблицу "
    "внутри моноширинного блока кода (используй тройные обратные кавычки ``` и моноширинный текст).\n"
    "Выравнивай столбцы пробелами, чтобы они стояли строго друг под другом на любом экране.\n"
