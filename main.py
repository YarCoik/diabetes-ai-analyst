...
system_instruction = (
    ...
    "- Для заголовков и разделов используй жирный шрифт: <b>📊 СТАТИСТИКА ДНЯ</b>, <b>💉 АНАЛИЗ БОЛЮСОВ И ЕДЫ</b>, <b>💡 КОРРЕКТИРОВКА БАЗАЛА</b>.\n"
    ...
    "Все дозировки базального инсулина в таблице пиши СТРОГО до тысячных долей (ровно 3 знака после запятой).\n"
    "Например, пиши 0.550 вместо 0.55, пиши 0.900 вместо 0.9, пиши 0.700 вместо 0.7.\n\n"
